import { MessageWithTextIcon } from '../../ui/icons/message-with-text-icon';
import { IIconProps } from '../../ui/icons/utils';

export default {
  title: 'UI/Icons',
  component: MessageWithTextIcon,
  argTypes: {
    color: {
      type: 'string',
...
const Template = (args: IIconProps) => <MessageWithTextIcon {...args} />;

export const MessageWithText = Template.bind({});
