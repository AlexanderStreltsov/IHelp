...
export const recipientRequestCompleted: Story = {
  args: {
    propsForRequest: {
      ...
      description:
        'Пожалуйста, погуляйте с моей собакой, я не смогу ее выгуливать с 12.06 по 24.06 потому что уеду на обследование к врачу. ',
      // с моей собакой, я не смогу ее выгуливать с 12.06 по 24.06 потому что уеду на обследование к врачу. Если есть желающие помочь в выгуле собаки, то звоните, 89041627779, Олег. Собаку зовут Айка, порода - немецкая овчарка, возраст - полтора года. Собака очень умная, послушная, добрая, спокойная.',
      completed: true,
      recipient: {
        id: 1,
...
export const volunteerRequestCompleted: Story = {
  args: {
    propsForRequest: {
      id: 1,
...
export const volunteerRequestActiveCanConfirm: Story = {
  args: {
    propsForRequest: {
      id: 1,
      title: 'Ещё Заголовок Заявки',
...
export const volunteerRequestActiveNoCancel: Story = {
  args: {
    propsForRequest: {
      id: 1,
      title: 'Ещё Заголовок Заявки',
...
export const volunteerRequestActiveNoConfirm: Story = {
  args: {
    propsForRequest: {
      id: 1,
      title: 'Ещё Заголовок Заявки',
