...
Страницы историй Storybook опубликованы по адресу: https://alexanderstreltsov.github.io/IHelp/?path=/docs/example-introduction--docs

Локальный запуск проекта осуществляется командой npm run start 
